...
namespace Quan_Ly_Dang_Ky_Hoc_Phan_Hoc_Phi
{
    internal class KETNOI_CSDL
    {
        ...
        //Data Source=localhost,1433;Initial Catalog=QLDKHP;Integrated Security=True
        public void KetNoi_Dulieu()
        {
            string strKetNoi = @"Data Source=localhost,1433;Initial Catalog=QLDKHP;Integrated Security=True";
